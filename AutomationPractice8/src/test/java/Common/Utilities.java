...
public class Utilities {
   ...
   public void Browsers(String browsers, String Wbsite) {
		  if(browsers.equalsIgnoreCase("Chrome")) {
			  ...
			  System.setProperty("webdriver.edge.driver", "C:\\Users\\riaz_\\git\\repository18\\AutomationPractice8\\src\\Drivers\\msedgedriver.exe");
...
File ks = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
 FileHandler.copy(ks, new File("C:\\Users\\riaz_\\git\\repository18\\AutomationPractice8\\Pictures\\"+sd+"picturesofwebsite.jpg"));
